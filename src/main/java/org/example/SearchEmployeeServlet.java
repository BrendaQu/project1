...
public class SearchEmployeeServlet extends HttpServlet {
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        out.println("<!DOCTYPE html>\n" +
                ...
                "        <br />\n" +
                "        <h6>Search for Employee by Id</h6>\n" +
                "        <form method='post' action='SearchEmployeeResultServlet' class=\"form-inline\">\n" +
                "            <div class=\"form-group row\">\n" +
                "                <div class=\"col-3\">\n" +
                "                    <input class=\"form-control\" type=\"text\" id=\"search\" name=\"search\" placeholder=\"Enter Employee ID\">\n" +
                "                </div>\n" +
                "                <div class=\"col\">\n" +
